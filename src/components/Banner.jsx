...
const Banner = () => (
    <div className=' bg-[#F7F7F7] w-full py-40'>
        <div className='grid items-center justify-between gap-3 md:grid-cols-2 max-w-[1145px] mx-auto md:px-2 px-5'>
            <div className='max-w-[500px]'>
                <h2 className=' text-4xl md:text-6xl font-bold'>Welcome to Our Fuits Shop</h2>
            ...
            <div>
                <img className=' max-w-[330px] mx-auto mt-6 md:max-w-[480px]' src="https://plantillashtmlgratis.com/wp-content/themes/helium-child/vista_previa/page279/tropiko/images/slide-img.png" alt="" />
            </div>
        </div>
    </div>
)
